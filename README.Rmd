...
-   Convert Visual Studio Code and TextMate themes into RStudio `.rstheme` format.
...
`convert_vs_to_tm_theme()` and `convert_tm_to_vs_theme()`, allowing you to
convert themes in both directions if needed.
