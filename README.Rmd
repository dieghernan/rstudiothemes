...
This project provides tools to convert and work with `.tmTheme` / `.json` (VS Code / TextMate) theme files and generate `.rstheme` files that can be installed into RStudio. RStudio supports custom themes (in `.rstheme` format) as of [version 1.2+](https://rstudio.github.io/rstudio-extensions/rstudio-theme-creation.html).
