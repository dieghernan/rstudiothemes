---
title: "Theme gallery"
subtitle: Preview the bundled RStudio themes
description: Preview the built-in themes
lightbox:
  match: auto
...
This article previews the **RStudio** themes bundled with **rstudiothemes**.
...
Previews may differ from the display on your device. The screenshots use the
following setup:
