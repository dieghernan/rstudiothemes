...
**Positron** and **TextMate** themes into **RStudio** `.rstheme` files and
...
This function writes the `.rstheme` file, installs it and applies it after
installation when `apply = TRUE`.
