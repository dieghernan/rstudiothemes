...
This adds many popular themes, including Tokyo Night, Nord, Winter is Coming
...
This function converts and installs the theme immediately. Set `apply = TRUE`
to apply it after installation.
