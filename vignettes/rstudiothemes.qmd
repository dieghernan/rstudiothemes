...
This adds many popular themes, including Tokyo Night, Nord, Winter is Coming and
...
This function converts and installs the theme immediately, optionally applying
it with `apply = TRUE`.
