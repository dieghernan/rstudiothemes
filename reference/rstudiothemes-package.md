...
Create and install custom 'RStudio' editor themes from 'Visual Studio
Code', 'Positron' and 'TextMate' themes. Convert themes between
'TextMate' and 'Visual Studio Code' or 'Positron' formats, and install
