...
GeomDotplot <- proto(Geom, {
  ...
  new <- function(
    ...
    if (
      ...
      message(
        "position=\"stack\" doesn't work properly with geom_dotplot. Use stackgroups=TRUE instead."
      )
    }
