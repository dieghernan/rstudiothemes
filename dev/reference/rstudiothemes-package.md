...
Create, convert and install custom 'RStudio' editor themes using 'Visual
Studio Code', 'Positron' and 'TextMate' themes. Convert themes between
'TextMate', 'Visual Studio Code' and 'Positron' formats, and install
bundled ports of popular 'Visual Studio Code' and 'Positron' themes.
...
- Garrick Aden-Buie <garrick@adenbuie.com> (for the
  rsthemes::try_rsthemes() function) \[copyright holder\]
