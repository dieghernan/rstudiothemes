...
Convert **Visual Studio Code**, **Positron** and **TextMate** theme files into
...
in `.rstheme` format since **RStudio** 1.2. See the [theme creation
documentation](https://rstudio.github.io/rstudio-extensions/rstudio-theme-creation.html).

## Features

- Convert **Visual Studio Code**, **Positron** and **TextMate** theme files
  into **RStudio** `.rstheme` files.
...
The online **Shiny** app includes many **rstudiothemes** conversion features
and lets you convert themes in a browser:
...
file to **RStudio** `.rstheme` format with this workflow:
