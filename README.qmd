...
**RStudio**-compatible `.rstheme` files. **RStudio** has supported custom
themes in `.rstheme` format since RStudio 1.2. See the [theme creation
...
The online **Shiny** app includes many **rstudiothemes** features, so you can
convert themes in a browser:
...
1.  Start with a **Visual Studio Code**, **Positron** or **TextMate** theme
