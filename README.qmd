...
RStudio 1.2 (see [theme creation
...
We also provide a Shiny App with many of the features of **rstudiothemes** that
lets you convert themes online. Try it out:
...
1.  Use a Visual Studio Code/Positron theme file, a TextMate theme file, or a
...
Alternatively, in RStudio go to **Tools \> Global Options \> Appearance \> Add**
...
- Visual Studio Code `.json`: See the official documentation on [creating color
