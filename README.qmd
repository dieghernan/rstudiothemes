...
This package provides tools to convert Visual Studio Code/Positron and TextMate
theme files (`.json` and `.tmTheme` formats) into RStudio-compatible `.rstheme`
files. RStudio has supported custom themes in `.rstheme` format since RStudio
1.2 (see [theme creation
