...
It is no longer being actively developed and support/maintenance will be
provided as time
...
prioritize **CRAN** compatibility and bug and regression fixes over new
features.
:::
...
- Install bundled ports of popular **Visual Studio Code** and **Positron**
  themes that are ready to use in **RStudio**.
...
<https://dieghernan.github.io/rstudiothemes/dist/rstudiothemes.zip>. Unzip the
file and install the themes using the [**RStudio** IDE
...
::: text-center
![](man/figures/rstudiogui.png){alt="RStudio IDE Add Theme interface" width="80%"}
:::
